...
if(!is_file("$mod_db")) {
	...
	$sql_events_table = generate_sql_query("../modules/checkin.mod/install/tpl-events.php");
	$sql_entries_table = generate_sql_query("../modules/checkin.mod/install/tpl-entries.php");
	$sql_preferences_table = generate_sql_query("../modules/checkin.mod/install/tpl-preferences.php");
	
	$dbh = new PDO("sqlite:$mod_db");
	
	$dbh->query($sql_events_table);
...
if($mod_prefs['version'] < $mod['version']) {
	...
	$all_tables = glob("../modules/checkin.mod/install/tpl-*.php");
